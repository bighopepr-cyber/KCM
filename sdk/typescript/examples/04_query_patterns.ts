/**
 * KCM TypeScript SDK — Query Patterns Example.
 *
...
console.log("=== KCM TypeScript SDK — Query Patterns Example ===\n");
...
const predicateFacts: FactData[] = byPredicate.collect();
...
const objectFacts: FactData[] = byObject.collect();
...
const multiFacts: FactData[] = multiCond.collect();
...
const allFacts: FactData[] = db.queryAll();
