/**
 * KCM TypeScript SDK — Basic CRUD Example.
 *
...
const resultFacts: FactData[] = result.collect();
...
// --- DELETE ---
console.log("\n--- Delete Fact ---");
const deleted: boolean = db.delete(row3);
